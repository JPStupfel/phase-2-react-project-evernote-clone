...
*/
function Content({content, contentStatus, updateContentPost, updateContentPatch, onCLickEditButton}) {
  ...
  const getContent = () => {
    if (contentStatus==='addNote') {
      ...
      return <NoteEditor updateContentPatch={updateContentPatch} content={content}/>
    }
